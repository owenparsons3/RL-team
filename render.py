...
net.load_state_dict(torch.load("/Users/mat66/Library/CloudStorage/OneDrive-UniversityofBath/MRes/Reinforcement Learning/rl_cw2/trained_45000", map_location = device))
